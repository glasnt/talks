...
---
 <!-- .slide: data-background="#000"-->
# Python 2.7 EOL <!-- .slide: data-state="27count" --> <!-- .slide: class="center" -->
#### <div id="27count" class="countdown"></div> <!-- .element: class="fragment" -->
...
## You get the commit bit ✨ <!-- .element: class="fragment" -->
...
---
 <div style='margin: 0 auto;'><p align='center'><img src='pictures/health_orgs.png'></p></div>  <!-- .slide: class="center" -->
...
---
 ...
 <div style='width: 50%; margin: 0 auto;'><p align='center'><img height='400px' src='pictures/eyeroll.svg'></p></div> <!-- .slide: class="center" -->
Note: 
