## Serialization formats <!-- .slide: class="center" -->
##are not toys <!-- .element: class="center" -->
Presented by <!-- .element: class="small-text center" --> Not Tom Eastman
...
## Who am I? <!-- .element: class="center" --> <!-- .slide: class="center" -->
...
## Who are you? <!-- .element: class="center" --> <!-- .slide: class="center" -->
...
## Serialization Formats <!-- .element: class="center" --> <!-- .slide: class="center" -->
...
### Why am I talking about this? <!-- .element: class="center" --> <!-- .slide: class="center" -->
...
### 90% of magic merely consists of knowing one extra fact. <!-- .element: class="center" --> <!-- .slide: class="center" -->
...
### K.I.S.S. <!-- .element: class="center" --> <!-- .slide: class="center" -->
