...
--
<pre><code class="python">>>> im = Image.open("image.png")</code></pre>
--
<pre><code class="python">>>> im.getpixel((1,1))</code></pre>
--
<pre><code class="python">(255, 255, 255, 255)</code></pre>
---
class: title
# Colour setting
---
...
---
background-image: url("images/full_floss.jpg")
---
background-image: url("images/wool_6floss.jpg")
---
class: title
...
lour <pre><code class="">drifting over time</code></pre>
...
<pre><code class="python">&nbsp;&nbsp;&nbsp; &nbsp; , palette.im)</code></pre>
---
class: top, image
![Image](images/window-wool_1.png)
---
class: top, image
![Image](images/window-wool_2.png)
---
.righthead[PIL.putpalette()]
<BR>
<pre><code class="python">>>> im.convert('P'</code></pre>
...
---
class: top, image
![Image](images/window-wool_3.png)
---
class: title
## Problem: 256
???
