...
### DjangoCon Europe 2018 <!-- .slide: class="center" -->
...
---
<pre><code><c>&dash;&dash; SQL</c><br><r>SELECT</r> <l>d</l>.<r>*</r> <br>&nbsp; <r>FROM</r> <l>unicodex_codepoint c,<br>&nbsp; &nbsp; &nbsp; &nbsp;unicodex_design d</l><br>&nbsp;<r>WHERE</r> <l>c</l>.<l>name</l> <r>&equals;</r> 'Sparkles'<BR><r>&nbsp; &nbsp;AND</r> d.codepoint_id = c.id;
...
---
<pre><code><c>&dash;&dash; SQL</c><br><r>SELECT</r> <l>d</l>.<r>*</r> <br>&nbsp; <r>FROM</r> <l>unicodex_codepoint c,<br>&nbsp; &nbsp; &nbsp; &nbsp;unicodex_design d</l><br>&nbsp;<r>WHERE</r> <l>c</l>.<l>name</l> <r>&equals;</r> 'Sparkles'<BR><r>&nbsp; &nbsp;AND</r> d.codepoint_id = c.id;<br><br><c>&num; ORM</c>
...
<r>SELECT</r> <l>d</l>.<r>*</r> <br>&nbsp;<r> FROM</r> <l>unicodex_codepoint c,<br>&nbsp; &nbsp; &nbsp; &nbsp;unicodex_design d</l><br>&nbsp;<r>WHERE</r> <l>c</l>.<l>name</l> <r>&equals;</r> 'Sparkles'<BR><r>&nbsp; &nbsp;AND</r> d.codepoint_id = c.id;
...
Note: press up to replay the line
---
 <div class="shell-wrap"><p class="shell-top-bar">python3.6</p><p class="shell-body">
 <ps>myrtle</ps> <dr>~ $</dr> 
cd project<br>
...
## `..twemoji-1.0.png🐛"` <!-- .slide: class="center" -->
...
---
## So <!-- .slide: class="center" -->

Note: So, the ORM is demonstratably great and all, but what if you have something reeeeeally complex, that you can't easily represent in the ORM?
---
